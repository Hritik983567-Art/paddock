...
const cspHeader = `
  ...
  connect-src 'self' ws: wss: https://api.jolpica.net https://api.jolpi.ca https://ergast.com https://*.supabase.co https://api.open-meteo.com https://accounts.google.com https://api.rss2json.com;
