...
const INITIAL_DRIVERS: LiveDriver[] = [
  { driverId: 'verstappen', code: 'VER', name: 'Max Verstappen', number: '1', teamId: 'red_bull', teamName: 'Red Bull Racing', position: 1, gapToLeader: 0.0, lastLapTime: '1:18.420', isFastestSector: false, speedTrap: 331, tyre: 'M', tyreAge: 4, status: 'RACING' },
  { driverId: 'norris', code: 'NOR', name: 'Lando Norris', number: '4', teamId: 'mclaren', teamName: 'McLaren', position: 2, gapToLeader: 1.2, lastLapTime: '1:18.510', isFastestSector: false, speedTrap: 328, tyre: 'M', tyreAge: 4, status: 'RACING' },
  { driverId: 'leclerc', code: 'LEC', name: 'Charles Leclerc', number: '16', teamId: 'ferrari', teamName: 'Scuderia Ferrari', position: 3, gapToLeader: 2.8, lastLapTime: '1:18.630', isFastestSector: false, speedTrap: 329, tyre: 'S', tyreAge: 6, status: 'RACING' },
  { driverId: 'hamilton', code: 'HAM', name: 'Lewis Hamilton', number: '44', teamId: 'ferrari', teamName: 'Scuderia Ferrari', position: 4, gapToLeader: 4.1, lastLapTime: '1:18.450', isFastestSector: true, speedTrap: 334, tyre: 'S', tyreAge: 5, status: 'RACING' },
  { driverId: 'piastri', code: 'PIA', name: 'Oscar Piastri', number: '81', teamId: 'mclaren', teamName: 'McLaren', position: 5, gapToLeader: 5.5, lastLapTime: '1:18.820', isFastestSector: false, speedTrap: 327, tyre: 'M', tyreAge: 4, status: 'RACING' },
  { driverId: 'russell', code: 'RUS', name: 'George Russell', number: '63', teamId: 'mercedes', teamName: 'Mercedes-AMG', position: 6, gapToLeader: 7.9, lastLapTime: '1:18.990', isFastestSector: false, speedTrap: 330, tyre: 'H', tyreAge: 3, status: 'RACING' },
  { driverId: 'sainz', code: 'SAI', name: 'Carlos Sainz', number: '55', teamId: 'williams', teamName: 'Williams Racing', position: 7, gapToLeader: 9.8, lastLapTime: '1:19.120', isFastestSector: false, speedTrap: 325, tyre: 'M', tyreAge: 7, status: 'RACING' },
  { driverId: 'alonso', code: 'ALO', name: 'Fernando Alonso', number: '14', teamId: 'aston_martin', teamName: 'Aston Martin', position: 8, gapToLeader: 12.3, lastLapTime: '1:19.340', isFastestSector: false, speedTrap: 326, tyre: 'H', tyreAge: 8, status: 'RACING' },
  { driverId: 'perez', code: 'PER', name: 'Sergio Perez', number: '11', teamId: 'red_bull', teamName: 'Red Bull Racing', position: 9, gapToLeader: 14.2, lastLapTime: '1:19.450', isFastestSector: false, speedTrap: 329, tyre: 'M', tyreAge: 9, status: 'RACING' },
  { driverId: 'gasly', code: 'GAS', name: 'Pierre Gasly', number: '10', teamId: 'alpine', teamName: 'Alpine F1 Team', position: 10, gapToLeader: 18.5, lastLapTime: '1:19.780', isFastestSector: false, speedTrap: 324, tyre: 'S', tyreAge: 10, status: 'RACING' },
  { driverId: 'tsunoda', code: 'TSU', name: 'Yuki Tsunoda', number: '22', teamId: 'rb', teamName: 'Visa Cash App RB', position: 11, gapToLeader: 21.0, lastLapTime: '1:19.920', isFastestSector: false, speedTrap: 328, tyre: 'S', tyreAge: 8, status: 'RACING' },
  { driverId: 'albon', code: 'ALB', name: 'Alex Albon', number: '23', teamId: 'williams', teamName: 'Williams Racing', position: 12, gapToLeader: 24.5, lastLapTime: '1:19.890', isFastestSector: false, speedTrap: 326, tyre: 'M', tyreAge: 12, status: 'RACING' },
  { driverId: 'hulkenberg', code: 'HUL', name: 'Nico Hulkenberg', number: '27', teamId: 'sauber', teamName: 'Stake Sauber', position: 13, gapToLeader: 28.0, lastLapTime: '1:20.120', isFastestSector: false, speedTrap: 322, tyre: 'H', tyreAge: 11, status: 'RACING' },
  { driverId: 'lawson', code: 'LAW', name: 'Liam Lawson', number: '30', teamId: 'rb', teamName: 'Visa Cash App RB', position: 14, gapToLeader: 30.5, lastLapTime: '1:20.340', isFastestSector: false, speedTrap: 325, tyre: 'M', tyreAge: 13, status: 'RACING' },
  { driverId: 'bearman', code: 'BEA', name: 'Ollie Bearman', number: '87', teamId: 'haas', teamName: 'Haas F1 Team', position: 15, gapToLeader: 32.8, lastLapTime: '1:20.550', isFastestSector: false, speedTrap: 323, tyre: 'H', tyreAge: 9, status: 'RACING' },
  { driverId: 'stroll', code: 'STR', name: 'Lance Stroll', number: '18', teamId: 'aston_martin', teamName: 'Aston Martin', position: 16, gapToLeader: 35.1, lastLapTime: '1:20.890', isFastestSector: false, speedTrap: 327, tyre: 'H', tyreAge: 14, status: 'RACING' },
  { driverId: 'bortoleto', code: 'BOR', name: 'Gabriel Bortoleto', number: '12', teamId: 'sauber', teamName: 'Stake Sauber', position: 17, gapToLeader: 38.4, lastLapTime: '1:21.110', isFastestSector: false, speedTrap: 321, tyre: 'S', tyreAge: 11, status: 'RACING' },
  { driverId: 'doohan', code: 'DOO', name: 'Jack Doohan', number: '7', teamId: 'alpine', teamName: 'Alpine F1 Team', position: 18, gapToLeader: 41.2, lastLapTime: '1:21.430', isFastestSector: false, speedTrap: 323, tyre: 'M', tyreAge: 15, status: 'RACING' },
  { driverId: 'colapinto', code: 'COL', name: 'Franco Colapinto', number: '43', teamId: 'williams', teamName: 'Williams Racing', position: 19, gapToLeader: 44.9, lastLapTime: '1:21.890', isFastestSector: false, speedTrap: 324, tyre: 'H', tyreAge: 16, status: 'RACING' },
  { driverId: 'ocon', code: 'OCO', name: 'Esteban Ocon', number: '31', teamId: 'haas', teamName: 'Haas F1 Team', position: 20, gapToLeader: 48.0, lastLapTime: '1:22.090', isFastestSector: false, speedTrap: 322, tyre: 'S', tyreAge: 13, status: 'RACING' }
];
